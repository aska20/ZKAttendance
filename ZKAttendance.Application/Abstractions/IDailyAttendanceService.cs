...
namespace ZKAttendance.Application.Abstractions
{
    ...
    public interface IEmailSender
    {
        ...
        /// <summary>
        /// Alias for <see cref="SendAsync"/> kept for compatibility with callers that use
        /// the older SendEmailAsync name (e.g. EmployeeLateNotificationService).
        /// Implementations delegate to SendAsync.
        /// </summary>
